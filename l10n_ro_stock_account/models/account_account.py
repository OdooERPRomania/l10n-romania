...
class AccountMoveLine(models.Model):
    ...
    # TO REMOVE ALL - putem folosi account_move_ids din sotck_account doar ca sa le afisam in form view
    ...
    # la ce foloseste? si daca foloseste trebie sa fie related to account.move
    stock_move_id = fields.Many2one(
        "stock.move",
        string="Stock Move",
        related="move_id.stock_move_id",
        store=True,
